            ...
            <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="block text-gray-900 mb-1 text-lg">Adresse</strong>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="block text-gray-900 mb-1 text-lg">Téléphone</strong>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="block text-gray-900 mb-1 text-lg">WhatsApp</strong>
                ...
                <li className="flex items-start gap-4">
                  <div className="bg-white p-3 rounded-full text-purple-500 shadow-sm shrink-0">
                    <Clock size={26} />
                  </div>
                  <div>
                    <strong className="block text-gray-900 mb-1 text-lg">Heures d'ouverture</strong>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="firstName" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none transition-all" placeholder="Votre prénom" required />
                </div>
                <div>
                  <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 mb-2">Nom *</label>
                  <input type="text" id="lastName" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none transition-all" placeholder="Votre nom" required />
                </div>
              </div>
              
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                <input type="email" id="email" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none transition-all" placeholder="votre@email.com" required />
              </div>

              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-2">Téléphone</label>
                <input type="tel" id="phone" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none transition-all" placeholder="+224 612 37 45 85" />
              </div>

              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-gray-700 mb-2">Sujet *</label>
                <select id="subject" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none bg-white transition-all" required>
              ...
              <div>
                ...
                <textarea id="message" rows="6" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] outline-none resize-y transition-all" placeholder="Décrivez votre besoin..." required></textarea>
              </div>

              <button 
                type="submit" 
                className="w-full bg-[var(--color-brand-orange)] hover:bg-orange-600 text-white font-bold py-4 rounded-2xl transition-all duration-300 text-lg shadow-lg shadow-orange-500/30"
              >
                Envoyer le message
              </button>
            </form>
