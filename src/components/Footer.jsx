...
const Footer = () => {
  return (
    <footer className="relative bg-slate-50 pt-20 pb-10 overflow-hidden border-t border-blue-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="inline-block" onClick={() => window.scrollTo({ top: 0, left: 0 })}>
              <img
                src={logoIBK}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 font-medium">
              <li><Link to="/a-propos" className="hover:text-[var(--color-brand-orange)] transition-colors" onClick={() => window.scrollTo({ top: 0, left: 0 })}>À propos de nous</Link></li>
              <li><Link to="/services" className="hover:text-[var(--color-brand-orange)] transition-colors" onClick={() => window.scrollTo({ top: 0, left: 0 })}>Nos Services</Link></li>
              <li><Link to="/formations" className="hover:text-[var(--color-brand-orange)] transition-colors" onClick={() => window.scrollTo({ top: 0, left: 0 })}>Nos Formations</Link></li>
              <li><Link to="/ecoles" className="hover:text-[var(--color-brand-orange)] transition-colors" onClick={() => window.scrollTo({ top: 0, left: 0 })}>Solutions pour Écoles</Link></li>
              <li><Link to="/actualites" className="hover:text-[var(--color-brand-orange)] transition-colors" onClick={() => window.scrollTo({ top: 0, left: 0 })}>Actualités</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm">
              <li className="flex items-start gap-3 group">
                ...
                <div>
                  <p className="  font-semibold">Dixinn Centre 1</p>
